...
In the Exploratory analyses, you will find:
<ul>
<li>Analysis of the popular music trend from 1999 to 2019, as well as the trend of substance use during this period at national level, and analysis of the relationship between substance use and the trend of substance description in the lyric </li>
</ul>

In the Regression Analyses tab, you will find:
<ul>
<li>Potential linear association between marijuana description in the lyrics and marijuana use.
...
# Team members
<ul>
<li>[Ling Guo](https://ling707.github.io/Ling707_p8105hw4_github.io/about.html)</li>
